...
struct AgentRuntimeAdapterTests {
    ...
    func adaptersOwnProcessCommandPlanning() {
        ...
        #expect(cursorPlan.arguments.contains("--trust") == false)
        #expect(cursorPlan.arguments.contains("--workspace") == false)
        #expect(cursorPlan.arguments.contains("--sandbox") == false)
        ...
        #expect(cursorPlan.commandPlannedFields["uses_trust"] == "false")
        #expect(cursorPlan.commandPlannedFields["uses_workspace"] == "false")
        #expect(cursorPlan.commandPlannedFields["uses_sandbox"] == "false")
